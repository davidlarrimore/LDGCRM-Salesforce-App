    ...
    if (-not $AccountId) {
        ...
        $AccountReviewRows.Add([PSCustomObject]@{
            ...
            Reason            = if ($AccountFromAirtableColumn) {
                                    "SKIPPED - not loaded. Airtable links this contact to an Account that isn't reconciled in $OrgAlias (duplicate/unmatched Airtable Account - see docs/TROUBLESHOOTING.md), and neither a linked Application nor a linked Opportunity resolves to one."
                                } else {
